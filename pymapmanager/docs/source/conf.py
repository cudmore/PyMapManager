# -*- coding: utf-8 -*-
#
# PyMapManager documentation build configuration file, created by
...
htmlhelp_basename = 'PyMapManagerdoc'
...
latex_documents = [
    (master_doc, 'PyMapManager.tex', u'PyMapManager Documentation',
     u'Robert H Cudmore', 'manual'),
]
...
man_pages = [
    (master_doc, 'pymapmanager', u'PyMapManager Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'PyMapManager', u'PyMapManager Documentation',
     author, 'PyMapManager', 'One line description of project.',
     'Miscellaneous'),
]
