...
console.log('loadMapButton',loadMapButton)
if (loadMapButton) {
	...
	function buildMapInterface(forceMaxProject) {
		for (var thisTP=0; thisTP<tmpNumTimepoint; thisTP+=1) {
			...
			*/
			...
			if (document.getElementById(thisDIVID)) {
...
//see: https://mattspitz.me/2013/11/20/serving-authenticated-media-with-nginx.html
//nginx can serve directly, works in docker
// http://localhost/images/public/rr30a/raw/ingested/tp0/rr30a_tp0_ch2_s0010.png
//tmpFile = 'rr30a_tp0_ch2_s0010.png'
tmpFile = $scope.leafletMap + '_tp' + tp + '_ch' + $scope.leafletChannel + '_s' + padToFour(sliceNum) + '.png'
imageUrl = serverurl + 'images/' + $scope.leafletUser + '/' + $scope.leafletMap + '/raw/ingested/tp' + tp + '/' + tmpFile
